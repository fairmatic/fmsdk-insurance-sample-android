...
class SampleAppApplication : Application() {
    ...
    override fun onCreate() {
        ...
        if (driverId != null ||
            ...
            FairmaticManager.sharedInstance().initializeFairmaticSDK(this, driverId, object:
                ...
                override fun onCompletion(result: FairmaticOperationResult) {
                    if(result is FairmaticOperationResult.Failure){
                        ...
                        Toast.makeText(this@SampleAppApplication, "Failed to initialize Fairmatic SDK : ${errorMessage.name}", Toast.LENGTH_SHORT).show()
                    }else{
                        Toast.makeText(this@SampleAppApplication, "Successfully initialized Fairmatic SDK", Toast.LENGTH_SHORT).show()
                    }
                }
            })
        }
